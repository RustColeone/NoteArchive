...
Node *pointerToMax(LinkedList *list)
{
   ...
   Node * maxtemp = list->head;
   while(temp != NULL){
      if(maxtemp->data < temp->data){
         maxtemp = temp;
      }
      temp = temp->next;
   }
   ...
   return maxtemp; // STUB!  Replace this line with correct code
}
...
Node *pointerToMin(LinkedList *list)
{
   ...
   return mintemp; // STUB!  Replace this line with correct code
}
